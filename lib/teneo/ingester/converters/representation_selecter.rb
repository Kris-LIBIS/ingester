    ...
    module Converters
      class RepresentationSelecter < Teneo::Ingester::Converters::Base::Selecter
        ...
        def dup_dir_item(item, parent)
          dir = Teneo::DataModel::DirItem.new(name: item.name)
          parent << dir
          path = dir.work_path
