...
module Teneo
  module Ingester
    ...
    class FormatDirIdentifier < Teneo::Ingester::Task
      include Base::Format
      ...
      parameter item_types: [Teneo::DataModel::Package], frozen: true
      ...
      def process(item, *_args)
        unless File.directory?(parameter(:folder))
          ...
          raise Teneo::Ingester::WorkflowAbort, "Value of 'folder' parameter in FormatDirIngester should be a directory name."
        end
        options = {
