...
class DbSetup < ActiveRecord::Migration[5.2]
  ...
  def change
    ...
    create_table :representation_defs do |t|
      t.integer :position
      ...
      t.references :from, foreign_key: { to_table: :representation_defs }
    ...
    create_table :conversion_workflows do |t|
      ...
      t.references :representation_def, foreign_key: true

      t.timestamps default: -> { "CURRENT_TIMESTAMP" }
      t.column :lock_version, :integer, null: false, default: 0

      t.index [:representation_def_id, :name], unique: true, name: "conversion_workflows_on_name"
